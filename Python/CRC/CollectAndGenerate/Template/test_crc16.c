...
void test_calculate_1(void)
{
    ...
    /* Calculate */
    TEST_ASSERT_EQUAL_HEX16(0x0000, crc16_calculate(NULL, data, sizeof(data)));
}
...
void test_calculate_2(void)
{
    ...
    /* Calculate */
    TEST_ASSERT_EQUAL_HEX16(0x0000, crc16_calculate(&configuration, NULL, sizeof(data)));
}
...
void test_calculate_3(void)
{
    ...
    for(size_t i = 0; i < CrcNameCount; i++)
    {
        ...
        /* Calculate */
        crc = crc16_calculate(&configuration, test_CheckData, sizeof(test_CheckData));
...
void test_calculate_4(void)
{
    ...
    {
        /* Set Up */
        memory = malloc(CRC16_LOOKUP_TABLE_MEMORY_SIZE);
...
void test_calculateAndAppend_1(void)
{
    ...
    /* Variable */
    uint8_t buffer[sizeof(test_CheckData) + sizeof(uint16_t)];

    /* Calculate And Append */
    crc16_calculateAndAppend(NULL, buffer, sizeof(buffer), sizeof(buffer) - sizeof(uint16_t));
}
...
void test_calculateAndAppend_2(void)
{
    ...
    /* Calculate And Append */
    crc16_calculateAndAppend(&configuration, NULL, sizeof(buffer), sizeof(buffer) - sizeof(uint16_t));
}
...
void test_calculateAndAppend_3(void)
{
    ...
    /* Calculate And Append */
    crc16_calculateAndAppend(&configuration, buffer, sizeof(buffer), sizeof(buffer));
}
...
void test_calculatePartial_1(void)
{
    ...
    /* Calculate Partial */
    crc = crc16_calculatePartial(NULL, 0x0000, 0x00, true, false);
...
void test_calculatePartial_2(void)
{
    ...
    for(size_t i = 0; i < CrcNameCount; i++)
    {
        ...
        for(size_t j = 0; j < sizeof(test_CheckData); j++)
            crc = crc16_calculatePartial(&configuration, crc, test_CheckData[j], (j == 0), (j == (sizeof(test_CheckData) - 1)));
...
void test_deinit_2(void)
{
    ...
    /* Verify */
    TEST_ASSERT_EQUAL_HEX16(0x0000, configuration.check);
    TEST_ASSERT_EQUAL_HEX16(0x0000, configuration.initial);
    TEST_ASSERT_NULL(configuration.lookupTable);
    TEST_ASSERT_EQUAL_HEX16(0x0000, configuration.polynomial);
    ...
    TEST_ASSERT_EQUAL_HEX16(0x0000, configuration.xorOut);
}
...
void test_init_1(void)
{
    ...
    /* Initialize */
    crc16_init(NULL, &configuration, false);
}
...
void test_init_3(void)
{
    ...
    /* Invalid Error */
    crc16_init("CRC-16/INVALID", &configuration, false);
}
...
void test_init_4(void)
{
    ...
    TEST_ASSERT_EQUAL_HEX16(ExpectedConfiguration.residue, actualConfiguration.residue);
    TEST_ASSERT_EQUAL_HEX16(ExpectedConfiguration.xorOut, actualConfiguration.xorOut);
}
...
##### REPLACEMENT 5 #####
    ...
    for(size_t i = 0; i < TestDataCount; i++)
    {
        ...
        TEST_ASSERT_EQUAL_HEX16(TestData[i].expectedConfiguration.residue, actualConfiguration.residue);
        TEST_ASSERT_EQUAL_HEX16(TestData[i].expectedConfiguration.xorOut, actualConfiguration.xorOut);
    }
}
...
void test_verify_1(void)
{
    ...
    /* Verify */
    TEST_ASSERT_FALSE(crc16_verify(NULL, buffer, sizeof(buffer)));
}
...
void test_verify_2(void)
{
    ...
    /* Verify */
    TEST_ASSERT_FALSE(crc16_verify(&configuration, NULL, sizeof(buffer)));
}
...
void test_verify_3(void)
{
    ...
    for(size_t i = 0; i < CrcNameCount; i++)
    {
        ...
        /* Verify */
        TEST_ASSERT_TRUE(crc16_verify(&configuration, buffer, sizeof(buffer)));
    }
}
